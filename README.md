...
Copy the package source into your ROS 2 workspace:

```bash
# Using your existing OM-X workspace
cp -r omx_pick_place_ws/omx_pick_place ~/omx_ws/src/

# Or create a dedicated workspace
mkdir -p ~/pick_place_ws/src
cp -r omx_pick_place_ws/omx_pick_place ~/pick_place_ws/src/
```
